...
if(!( function_exists('ebor_vc_add_att') )){
	function ebor_vc_add_attr(){
		...
		$attributes = array(
			"type" => "textfield",
			"heading" => esc_html__("Tab Title", 'malefic'),
		...
		$attributes = array(
			"type" => "textfield",
			"heading" => esc_html__("Row Type", 'malefic'),
		...
		$attributes = array(
			"type" => "textfield",
			"heading" => esc_html__("Gradient Colours", 'malefic'),
		...
		vc_add_param('malefic_team', $attributes);
		...
		vc_add_param('malefic_testimonial', $attributes);
		...
		vc_add_param('malefic_portfolio', $attributes);
		...
		vc_add_param('malefic_product', $attributes);
		...
		vc_add_param('malefic_post', $attributes);
