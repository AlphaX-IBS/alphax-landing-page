      ...
      <div class="retina-icons-code">
        ...
        <section id="brand">
          ...
          <div class="row fontawesome-icon-list margin-bottom-lg">
            ...
            <div class="col-md-3 col-sm-4"><i class="fa fa-malefic-exchange"></i> malefic-exchange</div>
            <div class="col-md-3 col-sm-4"><i class="fa fa-malefic-overflow"></i> malefic-overflow</div>
